...
class ShoppingListRepositoryImpl @Inject constructor(
   ...
   override suspend fun getShoppingLists() = dataSource.getShoppingLists()
    ...
    override suspend fun addIngredientToShoppingList(listId: String, item: ShoppingItemModel): Boolean = dataSource.addIngredientToShoppingListItemCollection(listId, item)
